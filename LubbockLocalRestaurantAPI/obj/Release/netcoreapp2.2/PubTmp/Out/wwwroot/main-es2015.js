...
let AppComponent = class AppComponent {
    constructor(authService, restaurantService) {
...
let ProfileComponent = class ProfileComponent {
    constructor(formBuilder, AuthService, Router, http) {
        this.formBuilder = formBuilder;
        this.AuthService = AuthService;
        this.Router = Router;
        this.http = http;
        ...
        this.AuthService.currentUser.subscribe(data => {
            ...
            this.ImagePath = "../../../" + data.user.profileImage;
            console.log(data);
...
let RestaurantsByTypeViewComponent = class RestaurantsByTypeViewComponent {
    constructor(route, restaurantService, router) {
        this.route = route;
        this.restaurantService = restaurantService;
        this.router = router;
...
RestaurantsByTypeViewComponent.ctorParameters = () => [
...
let SearchComponent = class SearchComponent {
    constructor(pipe, route, restaurantService, router) {
        this.route = route;
        this.restaurantService = restaurantService;
        this.router = router;
        ...
        this.restaurants$ = this.filter.valueChanges.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["startWith"])(''), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(text => this.search(text, pipe)));
    }
    ngOnInit() {
        Object(_angular_core_testing__WEBPACK_IMPORTED_MODULE_7__["async"])(() => {
            this.restaurantService.getAll().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["first"])())
                .subscribe(data => {
                this.Restaurants = data;
...
let RestaurantViewComponent = class RestaurantViewComponent {
    constructor(restaurantService, reviewService, router, route) {
        this.restaurantService = restaurantService;
        this.reviewService = reviewService;
        this.router = router;
        this.route = route;
    ...
    ngOnInit() {
        ...
        this.restaurantService.get(this.restaurantId).subscribe(data => {
...
RestaurantViewComponent.ctorParameters = () => [
    { type: _service_restaurant_service__WEBPACK_IMPORTED_MODULE_2__["RestaurantService"] },
